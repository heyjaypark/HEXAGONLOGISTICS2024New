...
<a href="productsearch.do?select_num=2&code=${param.code}&pageNo=${productPage.startPage - 5}">[以前]</a>
</c:if>
<c:forEach var="pNo"
begin="${productPage.startPage}"
end="${productPage.endPage}">
<a href="productsearch.do?select_num=2&code=${param.code}&pageNo=${pNo}">[${pNo}]</a>
</c:forEach>
<c:if test="${productPage.endPage < productPage.totalPages}">
<a href="productsearch.do?select_num=2&code=${param.code}&pageNo=${productPage.startPage + 5}">[次のページ]</a>
</c:if>
</td>
</tr>
</c:if>
